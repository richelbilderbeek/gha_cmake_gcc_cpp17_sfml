#############################################################################
# Makefile for building: gha_cmake_gcc_cpp17_boost
# Generated by qmake (3.1) (Qt 6.2.4)
# Project:  gha_cmake_gcc_cpp17_boost.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile gha_cmake_gcc_cpp17_boost.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++17 -Wall -Wextra -Wshadow -Wnon-virtual-dtor -pedantic -O2 -std=gnu++1z -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = gha_cmake_gcc_cpp17_boost1.0.0
DISTDIR = /home/richel/GitHubs/gha_cmake_gcc_cpp17_boost/.tmp/gha_cmake_gcc_cpp17_boost1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -lboost_graph /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		gha_cmake_gcc_cpp17_boost.pro  main.cpp
QMAKE_TARGET  = gha_cmake_gcc_cpp17_boost
DESTDIR       = 
TARGET        = gha_cmake_gcc_cpp17_boost


first: all
####### Build rules

gha_cmake_gcc_cpp17_boost:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: gha_cmake_gcc_cpp17_boost.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
all: Makefile gha_cmake_gcc_cpp17_boost
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++17 -Wall -Wextra -Wshadow -Wnon-virtual-dtor -pedantic -O2 -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp
